 ...
 */
$config['site_title']                 = "Sahabatkoe.com";       // Site Title, example.com
$config['admin_email']                = "iyes37445043@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name

$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['kasir_group']                = 'kasir';           // Default group, use name
