...
class Pelanggan extends Kasir_Controller
{
    ...
    public function index()
    {
		...
		$config['base_url'] 					= site_url('kasir/pelanggan/index/');
		...
		$this->load->view('kasir/pelanggan/view/index', $this->data);
    }
    ...
    public function search()
    {
        ...
        $view = $this->load->view('kasir/pelanggan/lib/search_table', $this->data);
        return $view;
