...
<form class="form-horizontal form-label-left" action="<?php echo url_web('admin/halaman/add'); ?>" method="post" enctype="multipart/form-data">
  ...
  <?php echo !empty($message) ? $message : ''; ?>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
			...
			<div class="form-group">
                <a href="<?php echo url_web('admin/images/modal_image_library'); ?>" class="btn btn-default" data-toggle="modal" data-target="#modalAddMedia"><i class="fa fa-file-image-o"></i> Tambah Media</a>
            </div>
