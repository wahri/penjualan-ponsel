			...
			<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
				<div class="row">
					<div class="input-group">
						<input type="text" id="inputSearchArticle" data-href="<?php echo url_web('admin/pelanggan/search'); ?>" class="form-control" placeholder="cari pelanggan...">
				...
				<div class="x_content">
					<table class="table">
						...
						<tbody id="tbodySearch">
							<?php $this->load->view('admin/pelanggan/lib/search_table'); ?>
						</tbody>
					</table>
				</div>
				<nav id="nav-index">
