        ...
        <div class="col-md-9 col-sm-9">
            <div>
                <ul class="nav nav-tabs">
                    ...
                    <li class="active" id="tabMediaLibrary" role="presentation" aria-controls="tabMediaLibrary" role="tab" data-toggle="tab"><a href="<?php echo url_web('admin/images/fitur_library_list'); ?>"
                ...
                <div class="tab-content" style="height: 350px; overflow-y: scroll;overflow-x: hidden;">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="media_library" >
                        <?php $this->load->view('admin/images/content_fieture_library'); ?>
                    </div><!-- /.tab-pane -->
					<div class="tab-pane " role="tabpanel" id="upload_media">
						</br></br></br>
                        <div style="width: 50%;margin: 0 auto;padding: 10px;border: 1px solid #999;">
                            <form id="formUploadFitur" class="form" action="<?php echo url_web('admin/images/upload_image/'); ?>" method="post" enctype="multipart/form-data">
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary btn-sm" id="btnSetFeaturedImage" data-href="<?php echo url_web('admin/images/detail_image'); ?>">Sisipkan Gambar</button>
  </div>
