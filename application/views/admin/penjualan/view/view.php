...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
			<div class="col-xs-12 table">
			  <table class="table table-striped">
				...
				<tbody>
				  <?php $this->load->view('admin/penjualan/lib/list_item'); ?>
				</tbody>
			  </table>
			</div>
			<!-- /.col -->
		...
		<div class="row no-print">
			<div class="col-xs-12">
			  <a href="<?php echo url_web('admin/penjualan/inv/'.$inv->id); ?>" target="_blank" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i> Cetak INV</a>
			  <a href="<?php echo url_web('admin/penjualan'); ?>" type="button" class="btn btn-info pull-right">Kembali</a>
			</div>
		</div>
