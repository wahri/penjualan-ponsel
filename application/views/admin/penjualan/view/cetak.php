		...
		<div class="physical-detail-content">
			<div class="detail">
				...
				<div class="item logistik">
					<span class="font-light">Logistics Priority</span>
					<p style="margin: 20px 0 0;font-size: 40px;line-height: 12px;"><strong><?php echo $kurir->kode; ?></strong></p>
				...
				<div class="item logistik" style="border-left: 1px solid; border-color: #060606;">
					...
					<p class="font-light">JLC 0045169114</p>
				</div>
			</div>
			<div class="detail">
    			<div class="item logistik">
