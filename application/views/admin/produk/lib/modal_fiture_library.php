        ...
        <div class="col-md-9 col-sm-9">
            <div>
                <ul class="nav nav-tabs">
                    ...
                    <li class="active" id="tabMediaLibrary" role="presentation" aria-controls="tabMediaLibrary" role="tab" data-toggle="tab"><a href="<?php echo url_web('admin/produk/fitur_library_list'); ?>"
                                                               data-target="#media_library" data-toggle="tabajax"
                                                               aria-expanded="false">Pustaka Media</a></li>
                ...
                <div class="tab-content" style="height: 350px; overflow-y: scroll;overflow-x: hidden;">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="media_library" >
                        <?php $this->load->view('admin/produk/lib/content_fieture_library'); ?>
                    </div><!-- /.tab-pane -->
					<div class="tab-pane " role="tabpanel" id="upload_media">
						</br></br></br>
                        <div style="width: 50%;margin: 0 auto;padding: 10px;border: 1px solid #999;">
                            <form id="formUploadFitur" class="form" action="<?php echo url_web('admin/produk/upload_image/'); ?>" method="post" enctype="multipart/form-data">
...
<div class="modal-footer">
	...
	<button data-batas-pilih="<?php echo $batas_pilih_image; ?>"
            data-type="<?php echo ($batas_pilih_image <= 5 ? 'tambah' : 'replace'); ?>"
            data-href="<?php echo url_web('admin/produk/add_image_item'); ?>" type="button" id="btnAddImageItem"
            class="btn btn-primary">Tambahkan Gambar Item
  </div>
